...
ID = readtable(['datasets/' 'miFISH_single_colour_overlap_' filename '.csv']);
...
%% Pairwise distances between the dots in the dual-color probes
figure(1)
subplot(2, 2, 1)
histogram(Dist, 30)
...
%% How many dots counted per allele
figure(2)
subplot(2, 2, 1)
